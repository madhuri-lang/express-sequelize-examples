...
const deleteAllItems = (req,res)=>{
  ...
  var str = `<img src="https://www.seekpng.com/png/detail/1-12928_cloud-png-blue-cloud-png-hd.png" height="100" width="200"><h2>Hello ${req.body.userEmail} !</h2><p>Thankyou for choosing us for your Cloud Services.We at PolicyCloud are determined to provide uninterrupted cloud services at minimal costs.</p><p>Your order details are as follows</p><p>*********************</p><table><tr><th>Plan Name</th><th>Plan Cost</th></tr>`;
  var cost = 0;
